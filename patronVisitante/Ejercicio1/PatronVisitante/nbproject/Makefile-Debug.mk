...
${OBJECTDIR}/nbproject/Bus.o: nbproject/Bus.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbproject/Bus.o nbproject/Bus.cpp

${OBJECTDIR}/nbproject/ComponenteEquipo.o: nbproject/ComponenteEquipo.cpp
	${MKDIR} -p ${OBJECTDIR}/nbproject
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbproject/ComponenteEquipo.o nbproject/ComponenteEquipo.cpp

${OBJECTDIR}/nbproject/Disco.o: nbproject/Disco.cpp
	${MKDIR} -p ${OBJECTDIR}/nbproject
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbproject/Disco.o nbproject/Disco.cpp

${OBJECTDIR}/nbproject/Equipo.o: nbproject/Equipo.cpp
	${MKDIR} -p ${OBJECTDIR}/nbproject
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbproject/Equipo.o nbproject/Equipo.cpp

${OBJECTDIR}/nbproject/Tarjeta.o: nbproject/Tarjeta.cpp
	${MKDIR} -p ${OBJECTDIR}/nbproject
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbproject/Tarjeta.o nbproject/Tarjeta.cpp

${OBJECTDIR}/nbproject/VisitanteEquipo.o: nbproject/VisitanteEquipo.cpp
	${MKDIR} -p ${OBJECTDIR}/nbproject
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbproject/VisitanteEquipo.o nbproject/VisitanteEquipo.cpp

${OBJECTDIR}/nbproject/VisitantePrecio.o: nbproject/VisitantePrecio.cpp
	${MKDIR} -p ${OBJECTDIR}/nbproject
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbproject/VisitantePrecio.o nbproject/VisitantePrecio.cpp

${OBJECTDIR}/nbproject/VisitantePrecioDetalle.o: nbproject/VisitantePrecioDetalle.cpp
	${MKDIR} -p ${OBJECTDIR}/nbproject
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbproject/VisitantePrecioDetalle.o nbproject/VisitantePrecioDetalle.cpp
